...
def banner():
    print("\n%s    _________ __     \n%s   / ____/ (_) /____  ║ %sDesign By : %sHanzTzy\n%s  / __/ / / / __/ _ \ ║ %sVersion   %s: %s%s1.2 \n / /___/ / / /_/  __/ ║ %sInstagram %s: %s@HundinTogam\n%s/_____/_/_/\__/\___/  ║ %sMy Github %s: %sgithub.com/HanzTzy\n"%(O,P,O,P,O,P,P,P,P,P,O,P,P,P,O,P))
def menu_log():
...
def menu():
    ...
    print('%s╠══[%s•%s] %sName : HanzTzy'%(O,P,O,P))
